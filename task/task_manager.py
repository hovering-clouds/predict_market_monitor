...
class TaskManager:
    ...
    def create_arbitrage(self, cfg: Dict[str, Any]) -> Dict[str, Any]:
        ...
        return {
            ...
            'min_order_quantity': task.min_order_quantity,
            'min_order_amount': task.min_order_amount,
            'price_deviation_tolerance': task.price_deviation_tolerance,
            'max_risk_exposure': task.max_risk_exposure,
            ...
            for mid, t in self._tasks.items():
                if isinstance(t, ArbitrageTask):
                    ...
                    result.append({
                        ...
                        'price_deviation_tolerance': t.price_deviation_tolerance,
                        'max_risk_exposure': t.max_risk_exposure,
